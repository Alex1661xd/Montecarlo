...
{
    default double calculatePi(int totalPoints)
    {
        return calculatePi(totalPoints, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default double calculatePi(int totalPoints, java.util.Map<String, String> context)
    {
        return _iceI_calculatePiAsync(totalPoints, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> calculatePiAsync(int totalPoints)
    {
        return _iceI_calculatePiAsync(totalPoints, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> calculatePiAsync(int totalPoints, java.util.Map<String, String> context)
    {
        return _iceI_calculatePiAsync(totalPoints, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> _iceI_calculatePiAsync(int iceP_totalPoints, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default void removeWorker(WorkerPrx worker)
    {
        removeWorker(worker, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void removeWorker(WorkerPrx worker, java.util.Map<String, String> context)
    {
        _iceI_removeWorkerAsync(worker, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> removeWorkerAsync(WorkerPrx worker)
    {
        return _iceI_removeWorkerAsync(worker, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> removeWorkerAsync(WorkerPrx worker, java.util.Map<String, String> context)
    {
        return _iceI_removeWorkerAsync(worker, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_removeWorkerAsync(WorkerPrx iceP_worker, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "removeWorker", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeProxy(iceP_worker);
                 }, null);
        return f;
